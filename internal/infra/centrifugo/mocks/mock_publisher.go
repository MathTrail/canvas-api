...
func (_m *MockPublisher) Publish(ctx context.Context, channel string, data []byte) error {
...
//   - channel string
//   - data []byte
func (_e *MockPublisher_Expecter) Publish(ctx interface{}, channel interface{}, data interface{}) *MockPublisher_Publish_Call {
	return &MockPublisher_Publish_Call{Call: _e.mock.On("Publish", ctx, channel, data)}
}

func (_c *MockPublisher_Publish_Call) Run(run func(ctx context.Context, channel string, data []byte)) *MockPublisher_Publish_Call {
...
func (_c *MockPublisher_Publish_Call) RunAndReturn(run func(context.Context, string, []byte) error) *MockPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
